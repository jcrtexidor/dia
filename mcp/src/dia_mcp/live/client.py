        ...
        try:
            with socket.socket(socket.AF_UNIX, socket.SOCK_STREAM) as sock:
                ...
                def exchange(value):
                    ...
                    sock.sendall(encode(value, self.limits.request_bytes))
                    while b"\n" not in buffer:
                    ...
                    if "error" in result:
                        ...
                        raise DiaError(error["code"], error["message"])
            ...
            raise DiaError("REQUEST_TIMEOUT", "Live request timed out") from exc
